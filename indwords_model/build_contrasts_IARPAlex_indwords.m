function [consess,existingcontrasts] = build_contrasts_IARPAlex_indwords(subj,SPMfn,params)
...
%'Con2Name',...;}
existingcontrasts=[];
% made in the file make_contrast_cell_indwords.m, loads cell called
% Contrasts
load contrastsCell_indwords.mat
%%
