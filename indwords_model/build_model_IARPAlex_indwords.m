...
% Modified for IARPA lexical analyses version 1 - each word is a condition
% moved some things around for more intuitive documentation
% Brianna Pritchett, bpritche
% 10/28/2015

function sess = build_model_IARPAlex_indwords(varargin)
    % build_model_IARPAlex_indwords(subject_name, niifiles[, motionfiles, outliers, hpf])
    ...
    model_name='model_wordCond_IARPA'; 
    ...
    parafiles_dir='/mindhive/evlab/u/bpritche/Documents/fMRI_analyses/PARAS/IARPAlex_indwords';
