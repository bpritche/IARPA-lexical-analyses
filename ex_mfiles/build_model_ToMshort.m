...
if(numel(varargin) < 2)
  ...
  model_name='model_ToMshort'; % just 'model'  or 'model_<model_name>'
  subjects_dir = '/mindhive/nklab2/iblank/database_032015_onward/'; 
  catfiles_dir='';
  parafiles_dir='/mindhive/nklab2/iblank/PARAS/';
