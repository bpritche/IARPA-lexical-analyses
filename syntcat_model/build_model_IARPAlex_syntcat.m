...
% Modified for IARPA lexical analyses version 2 - each syntactic category is a condition 
% moved some things around for more intuitive documentation
% Brianna Pritchett, bpritche
% 10/28/2015

function sess = build_model_IARPAlex_syntcat(varargin)
    % build_model_IARPAlex_syntcat(subject_name, niifiles[, motionfiles, outliers, hpf])

    %% CHANGE:
    % names: a cell array with a string representint each condition
    names = {'N', 'Adj', 'V', 'Adv', 'FunctionWord'};
    ...
    model_name='model_IARPAlex_syntcat'; 
    ...
    parafiles_dir='/mindhive/evlab/u/bpritche/Documents/fMRI_analyses/PARAS/IARPAlex_syntcat';
