...
function sess = build_model_IARPAlex_syntcatFreq(varargin)
    ...
    names = {'N_hi','N_med','N_lo','OTH_hi','OTH_med','OTH_lo'};
    ...
    model_name='model_IARPAlex_syntcatFreq'; 
    ...
    parafiles_dir='/mindhive/evlab/u/bpritche/Documents/fMRI_analyses/PARAS/IARPAlex_syntcatFreq';
