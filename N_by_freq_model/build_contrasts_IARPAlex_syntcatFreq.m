function [consess,existingcontrasts] = build_contrasts_IARPAlex_syntcatFreq(subj,SPMfn,params)
...
Contrasts = ...
    ...
    {'OTH_med', 'OTH_med', 1};
    {'OTH_lo', 'OTH_lo', 1};
    {'N_hi-N_med', 'N_hi', 1, 'N_med', -1};
    {'N_med-N_lo', 'N_med', 1, 'N_lo', -1};
    {'N_hi-N_lo', 'N_hi', 1, 'N_lo', -1};
    {'paramHtoL', 'N_hi', 1, 'N_med', 0, 'N_lo', -1};
    {'paramLtoH', 'N_lo', 1, 'N_med', 0, 'N_hi', -1};
    };
%%
