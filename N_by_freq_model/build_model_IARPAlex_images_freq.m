...
% Modified for IARPA lexical analyses version 3 - 
% conditions are 'high', 'medium' or 'low' frequency 
% moved some things around for more intuitive documentation
% Brianna Pritchett, bpritche
% 10/28/2015

function sess = build_model_IARPAlex_images_freq(varargin)
    % build_model_IARPAlex_sentences_freq(subject_name, niifiles[, motionfiles, outliers, hpf])

    %% CHANGE:
    % names: a cell array with a string representint each condition
    names = {'H', 'M', 'L'};
    ...
    model_name='model_IARPAlex_images_freq'; 
    ...
    parafiles_dir='/mindhive/evlab/u/bpritche/Documents/fMRI_analyses/PARAS/IARPAlex_freq';
